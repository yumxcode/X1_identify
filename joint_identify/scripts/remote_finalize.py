...
Runs, in order:
  ...
  4. SPI five-criterion validation of the committed R8 params
...
startScript:
  gm-run X1_identify/joint_identify/scripts/remote_finalize.py
"""
import subprocess
import sys
...
def main():
    ...
    # 4: five-criterion SPI validation on the committed R8 params
    rc_spi = run([py, "spi_identify/scripts/validate_spi.py",
                  ...
                  "--params", "spi_identify/results/r8_newdata_identified_params.json",
                  "--out-dir", "logs/spi_sysid"],
                 "SPI validation (5 criteria, R8 params, re-baselined floors)")
