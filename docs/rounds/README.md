...
| 2026-09-04 | P1/P2 方法学修复落码 | 修复 | R-7 质心惯量语义（双向 Steiner）+ 三角不等式检查；multiple shooting/延迟回放/通道归一化/零模型 bar （修 R-1 90.2% 独占与地板退化）；ACTUATOR R²≥0.80 过滤带 [0.546,0.706]；官方区间视图 identified_intervals.json（κs/m 0.113-0.117）；新门禁远端重跑证据 PENDING-TERMINAL（账号资源持久耗尽：8 次尝试零计算，最近探测 2026-09-05 07:10 CST 池空+本地被拒；充值后单任务即闭环） | [2026-09-04_sysid_review.md §13](2026-09-04_sysid_review.md) |
