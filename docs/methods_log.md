...
- **门禁语义变更的远端重跑证据：已闭环（2026-09-08，TASK_20260908_225）**——账号池恢复（id=45/46 补充）后单任务闭环：**R9 在新门禁下 `verdict: FAIL (exit 1)`，PREDICTION 逐项确认**（ACCEL best=13.541 vs bar=2.423=运行时零模型 0.808×3；ACTUATOR κs=0.370 ∉ [0.546,0.706]；EFFECTIVENESS/PHYSICAL/CROSS-DATASET 三项 PASS）= R-4/R-5 代码级确认。全量日志 `spi_identify/results/remote_logs/P1V9_TASK_20260908_225_validate_newgate.log`。历史阻塞（2026-09-05 终态留档）：5 次尝试零计算（127 pypi 超时 / 142·144·155 池内无余额 / 145 中止 / 170 本地被拒），第 6/7/8 次探测（TASK_20260905_032/033/034）同签名，证据 P1V5_*.txt。
